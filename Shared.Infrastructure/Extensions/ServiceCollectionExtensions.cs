...
namespace Shared.Infrastructure.Extensions
{
    ...
    {
        public static IServiceCollection AddSharedInfrastructue(this IServiceCollection services, IConfiguration config)
        {
        ...
        public static IServiceCollection AddMSSQLDbContext<T>(this IServiceCollection services, IConfiguration config)
            where T: DbContext
        {
